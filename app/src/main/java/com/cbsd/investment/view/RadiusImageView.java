package com.cbsd.investment.view;
...
public class RadiusImageView extends AppCompatImageView {
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        //  半径
        radius = ta.getDimension(R.styleable.RadiusImageView_radius, 0);
        topLeftRadius = ta.getDimension(R.styleable.RadiusImageView_topLeftRadius, 0);
        topRightRadius = ta.getDimension(R.styleable.RadiusImageView_topRightRadius, 0);
        bottomLeftRadius = ta.getDimension(R.styleable.RadiusImageView_bottomLeftRadius, 0);
        bottomRightRadius = ta.getDimension(R.styleable.RadiusImageView_bottomRightRadius, 0);
        //  展示类型
        styleType = ta.getInt(R.styleable.RadiusImageView_scaleType, TOP);
        //  描边
        borderWidth = ta.getDimension(R.styleable.RadiusImageView_borderWidth, 0);
        borderSpace = ta.getDimension(R.styleable.RadiusImageView_borderSpace, 0);
        borderColor = ta.getColor(R.styleable.RadiusImageView_borderColor, Color.WHITE);

        //  不常用属性
        topLeftRadius_x = ta.getDimension(R.styleable.RadiusImageView_topLeftRadius_x, 0);
        topLeftRadius_y = ta.getDimension(R.styleable.RadiusImageView_topLeftRadius_y, 0);
        topRightRadius_x = ta.getDimension(R.styleable.RadiusImageView_topRightRadius_x, 0);
        topRightRadius_y = ta.getDimension(R.styleable.RadiusImageView_topRightRadius_y, 0);
        bottomLeftRadius_x = ta.getDimension(R.styleable.RadiusImageView_bottomLeftRadius_x, 0);
        bottomLeftRadius_y = ta.getDimension(R.styleable.RadiusImageView_bottomLeftRadius_y, 0);
        bottomRightRadius_x = ta.getDimension(R.styleable.RadiusImageView_bottomRightRadius_x, 0);
        bottomRightRadius_y = ta.getDimension(R.styleable.RadiusImageView_bottomRightRadius_y, 0);
